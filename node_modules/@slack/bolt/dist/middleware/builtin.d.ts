import { Middleware, AnyMiddlewareArgs, SlackActionMiddlewareArgs, SlackCommandMiddlewareArgs, SlackEventMiddlewareArgs, SlackOptionsMiddlewareArgs, SlackEvent, SlackAction, SlashCommand, ViewSubmitAction, OptionsRequest, ContextMissingPropertyError, SlackViewMiddlewareArgs } from '../types';
 ...
 */
export declare const onlyViewSubmits: Middleware<AnyMiddlewareArgs & {
    view?: ViewSubmitAction;
}>;
export declare function matchCallbackId(callbackId: string | RegExp): Middleware<SlackViewMiddlewareArgs>;
/**
 * Middleware that checks for matches given constraints
 */
export declare function matchConstraints(constraints: ActionConstraints): Middleware<SlackActionMiddlewareArgs | SlackOptionsMiddlewareArgs>;
